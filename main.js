...
var ToRad, addStaticBox, antialias, basicTexture, bodys, camera, canvas, clearMesh, controls, fps, geos, gradTexture, gravity, green, grounds, infos, init, initOimoPhysics, isMobile, light, main_loop, mats, meshs, onWindowResize, populate, renderer, rnd, scene, type, updateOimoPhysics, world;
...
populate = function() {
  ...
  while (i--) {
    ...
    results.push(scene.add(meshs[i]));
  }
  return results;
};
